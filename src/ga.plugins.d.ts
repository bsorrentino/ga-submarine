...
export type ProgressBar = {
    ...
    create( canvas:HTMLCanvasElement, assets:Array<string> ):void;
    update():void;
    remove():void;
}
...
/// [N] `slide`: Ease a sprite to a specific position.
/// [N] `fadeIn`: Fade in a sprite.
/// [N] `fadeOut`: Fade out a sprite.
/// [N] `fade`: Fades in or out.
/// [N] `pulse`: Uses the `fade` method to make a sprite's alpha oscillate.
/// [N] `follow`: Make a sprite follow another sprite at a fixed speed.
/// [N] `rotateSprite`: Make a sprite rotate around the center of another sprite.
/// [N] `rotatePoint`: Make any x/y point rotate around any other point.
